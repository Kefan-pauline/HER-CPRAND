...
def CPRAND_old(tensor,rank,n_samples,factors=None,exact_err=False,it_max=100,err_it_max=20,tol=1e-7,list_factors=False,time_rec=False):
  """
    CPRAND for CP-decomposition, with err_rand_fast
    return also exact error
