...
from src._base import random_init_fac,err_fac, init_factors, score
...
def comparison(I,J,K,r,nb_rand,n_samples,n_samples_err,exact_err=False,scale=False,noise_level=0.1,tol=0.11):
  """
  ...
  for i in range(nb_rand) : 
    ...
    for k in range(5):
      ...
      weights3,l_fac[3],it[3],error[3],err_es3,l_fac3,time[3]=CPRAND(t,r,n_samples,n_samples_err,factors=copy.deepcopy(factors),exact_err=True,it_max=200,err_it_max=200,tol=tol,list_factors=True,time_rec=True)
      weights4,l_fac[4],it[4],error[4],err_es4,cpt4,l_fac4,time[4]=her_CPRAND(t,r,n_samples,n_samples_err,factors=copy.deepcopy(factors),exact_err=True,it_max=200,err_it_max=200,tol=tol,list_factors=True,time_rec=True) 
      weights5,l_fac[5],it[5],error[5],err_es5,l_fac5,time[5]=CPRAND(t,r,n_samples,100,factors=copy.deepcopy(factors),exact_err=True,it_max=200,err_it_max=200,tol=tol,list_factors=True,time_rec=True)
      weights6,l_fac[6],it[6],error[6],err_es6,cpt6,l_fac6,time[6]=her_CPRAND(t,r,n_samples,100,factors=copy.deepcopy(factors),exact_err=True,it_max=200,err_it_max=200,tol=tol,list_factors=True,time_rec=True) 
      # information storage
...
def compar_filter(I,J,K,r,nb_rand,n_samples,n_samples_err,exact_err=False,scale=False,noise_level=0.1,tol=0.11):
  ...
  for i in range(nb_rand) : 
    ...
    for k in range(5):
      ...
      # run 4 methods
      weights1,l_fac[1],it[1],error[1],cpt1,l_fac1,time[1]=her_Als(t,r,factors=copy.deepcopy(factors),it_max=200,tol=tol,list_factors=True,time_rec=True)  
      weights4,l_fac[2],it[2],error[2],err_es4,cpt4,l_fac4,time[2]=her_CPRAND(t,r,n_samples,n_samples_err,factors=copy.deepcopy(factors),exact_err=True,it_max=200,err_it_max=200,tol=tol,list_factors=True,time_rec=True) 
      weights6,l_fac[3],it[3],error[3],err_es6,cpt6,l_fac6,time[3]=her_CPRAND(t,r,n_samples,n_samples_err,factors=copy.deepcopy(factors),exact_err=True,it_max=200,err_it_max=200,tol=tol,list_factors=True,time_rec=True,filter=5) 
      # information storage
